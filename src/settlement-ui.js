import {CROPS,BUILDINGS,WEAPONS,FARM_UPGRADES,SPECIAL_AMMO,SPELL_SCROLLS} from './world.js';
...
export function setupSettlement(world,{save,onBuild}){
  ...
  function refresh(){
    ...
    const categories=[['crops','Seeds & produce'],['livestock','Eggs & dairy'],['buildings','Homes & land'],['weapons','Weapons'],['magic','Magic & arrows'],['engineering','Engineering'],['household','Household']];
