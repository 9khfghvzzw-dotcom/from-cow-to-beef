...
export function setupSettlement(world,{save,onBuild}){
  ...
  function refresh(){
    ...
    const categories=[['crops','Seeds & produce'],['loot','Monster loot'],['livestock','Eggs & dairy'],['buildings','Homes & land'],['weapons','Weapons'],['magic','Magic & arrows'],['engineering','Engineering'],['household','Household']];
