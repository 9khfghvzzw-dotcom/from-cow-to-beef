...
assert split>fade>=0
filters=f'[0:a]asplit=2[a][b];[a]atrim=0:{split},asetpts=PTS-STARTPTS[first];[b]atrim=start={split},asetpts=PTS-STARTPTS[last];[first][1:a]acrossfade=d={fade}:c1=tri:c2=tri[mid];[mid][last]acrossfade=d={fade}:c1=tri:c2=tri[out]'
